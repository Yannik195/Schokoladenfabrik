...
class __TwigTemplate_b76a034d1a76f98cc47719c6e640a1e5a08da9adbf79d58eb64dab1444969c0e extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    ";
        if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "count", [], "any", false, false, false, 4), 0))) {
            // line 5
            echo "        ";
            ob_start();
            // line 6
            ...
            <span class=\"sf-toolbar-value\">
                ";
            // line 8
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "count", [], "any", false, false, false, 8), "html", null, true);
            echo "</span>
        ";
        ...
        ";
            ...
            // line 14
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "count", [], "any", false, false, false, 14), "html", null, true);
            echo "</span>
            </div>
        ";
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        echo (( !twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "count", [], "any", false, false, false, 23)) ? ("disabled") : (""));
        echo "\">
        <span class=\"icon\">";
        // line 24
        echo twig_include($this->env, $context, "@Enqueue/Icon/icon.svg");
...
";
    ...
    public function block_panel($context, array $blocks = [])
    {
        ...
        // line 30
        echo "    ";
        if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "count", [], "any", false, false, false, 30), 0))) {
            // line 31
            echo "    <h2>Sent messages</h2>
        ";
            // line 32
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "sentMessages", [], "any", false, false, false, 32));
            foreach ($context['_seq'] as $context["clientName"] => $context["sentMessages"]) {
                ...
                <table>
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["sentMessage"]) {
                        ...
                        echo "</td>
                            <td style=\"width: 70%\" class=\"metadata\">
                                <span>
                                    ";
                        // line 54
                        $context["body"] = twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "ensureString", [0 => twig_get_attribute($this->env, $this->source, $context["sentMessage"], "body", [], "any", false, false, false, 54)], "method", false, false, false, 54);
                        // line 55
                        echo "                                    ";
                        echo twig_escape_filter($this->env, (((1 === twig_compare(twig_length_filter($this->env, ($context["body"] ?? null)), 40))) ? ((twig_slice($this->env, ($context["body"] ?? null), 0, 40) . "...")) : (($context["body"] ?? null))), "html", null, true);
                        echo "
                                </span>
                                ";
                        // line 57
                        if ((1 === twig_compare(twig_length_filter($this->env, ($context["body"] ?? null)), 40))) {
                            // line 58
                        ...
                        echo "\">";
                        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "prettyPrintPriority", [0 => twig_get_attribute($this->env, $this->source, $context["sentMessage"], "priority", [], "any", false, false, false, 68)], "method", false, false, false, 68), "html", null, true);
                        echo "</span>
                            </td>
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Enqueue/Profiler/panel.html.twig", "/var/www/html/vendor/enqueue/enqueue-bundle/Resources/views/Profiler/panel.html.twig");
    }
}
